...
class CreateProfileTestCase(TestCase):
    ...
    def test_success_response(self):
        post_data = {'username': 'Test User', 'first_name': 'max', 'last_name': 'luo', 'location': 'Cville',
                     'email': 'maxo@virginia.edu'}
        c = Client()
    ...
    def test_error_response(self):
        ...
        post_data = {'username': 'Test User', 'last_name': 'luo', 'location': 'Cville',
                     'email': 'maxo@virginia.edu'}
        c = Client()
        response = c.post('/api/v1/profiles/create', post_data)
        json_obj = json.loads((response.content).decode("utf-8"))
